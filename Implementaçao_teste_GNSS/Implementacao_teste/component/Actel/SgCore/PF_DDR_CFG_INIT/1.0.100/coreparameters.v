//--------------------------------------------------------------------
// Created by Microsemi SmartDesign Wed Jul 30 23:03:53 2025
// Parameters for PF_DDR_CFG_INIT
//--------------------------------------------------------------------


parameter DEF_ADDR_VCOPHS_OFFSET = 4;
...
parameter DEF_CFG_BANKADDR_MAP = 49866;
...
parameter DEF_CFG_CCD_L = 0;
parameter DEF_CFG_CCD_S = 0;
parameter DEF_CFG_CHIPADDR_MAP = 27;
parameter DEF_CFG_CIDADDR_MAP = 0;
parameter DEF_CFG_CKSRE = 0;
parameter DEF_CFG_CKSRX = 0;
parameter DEF_CFG_CL = 5;
parameter DEF_CFG_COLADDR_MAP_0 = 67903552;
parameter DEF_CFG_COLADDR_MAP_1 = 75613716;
parameter DEF_CFG_COLADDR_MAP_2 = 2;
...
parameter DEF_CFG_MEM_BANKBITS = 3;
parameter DEF_CFG_MEM_COLBITS = 10;
parameter DEF_CFG_MEM_ROWBITS = 14;
parameter DEF_CFG_MEMORY_TYPE = 256;
parameter DEF_CFG_MIN_READ_IDLE = 1;
parameter DEF_CFG_MIRROR_X16_BG0_BG1 = 0;
parameter DEF_CFG_MOD = 12;
parameter DEF_CFG_MPR_READ_FORMAT = 0;
parameter DEF_CFG_MRR = 4;
parameter DEF_CFG_MRRI = 0;
parameter DEF_CFG_MRW = 10;
...
parameter DEF_CFG_ODT_INBUF_4_PD = 0;
...
parameter DEF_CFG_RC = 42;
parameter DEF_CFG_RCD = 12;
parameter DEF_CFG_RCD_STAB = 0;
parameter DEF_CFG_RD_PREAMB_TRN_MODE = 0;
parameter DEF_CFG_RD_PREAMBLE = 0;
parameter DEF_CFG_RDIMM_BSIDE_INVERT = 0;
parameter DEF_CFG_RDIMM_LAT = 0;
parameter DEF_CFG_READ_DBI = 0;
parameter DEF_CFG_READ_TO_READ = 1;
parameter DEF_CFG_READ_TO_READ_ODT = 1;
parameter DEF_CFG_READ_TO_WRITE = 1;
parameter DEF_CFG_READ_TO_WRITE_ODT = 1;
parameter DEF_CFG_REF_PER = 2600;
parameter DEF_CFG_REGDIMM = 0;
parameter DEF_CFG_RFC = 87;
parameter DEF_CFG_RFC1 = 0;
...
parameter DEF_CFG_RL = 10;
parameter DEF_CFG_RMW_EN = 0;
parameter DEF_CFG_ROWADDR_MAP_0 = 21033869;
parameter DEF_CFG_ROWADDR_MAP_1 = 156570441;
parameter DEF_CFG_ROWADDR_MAP_2 = 110715253;
parameter DEF_CFG_ROWADDR_MAP_3 = 0;
parameter DEF_CFG_RP = 14;
parameter DEF_CFG_RRD = 7;
parameter DEF_CFG_RRD_DLR = 0;
parameter DEF_CFG_RRD_L = 0;
parameter DEF_CFG_RRD_S = 0;
parameter DEF_CFG_RTP = 5;
parameter DEF_CFG_RTT = 0;
parameter DEF_CFG_RTT_PARK = 0;
parameter DEF_CFG_RTT_WR = 0;
parameter DEF_CFG_SR_ABORT = 0;
parameter DEF_CFG_SRT = 0;
parameter DEF_CFG_STARTUP_DELAY = 133334;
...
parameter DEF_CFG_WRITE_TO_WRITE = 0;
parameter DEF_CFG_WRITE_TO_WRITE_ODT = 0;
parameter DEF_CFG_WTR = 5;
parameter DEF_CFG_WTR_L = 0;
parameter DEF_CFG_WTR_L_CRC_DM = 0;
parameter DEF_CFG_WTR_S = 0;
parameter DEF_CFG_WTR_S_CRC_DM = 0;
parameter DEF_CFG_XP = 6;
parameter DEF_CFG_XPR = 5;
parameter DEF_CFG_XS = 5;
parameter DEF_CFG_XSDLL = 0;
parameter DEF_CFG_XSR = 31;
parameter DEF_CFG_ZQ_CAL_L_DURATION = 240;
parameter DEF_CFG_ZQ_CAL_PER = 133334;
parameter DEF_CFG_ZQ_CAL_R_DURATION = 34;
parameter DEF_CFG_ZQ_CAL_S_DURATION = 60;
parameter DEF_CFG_ZQ_CAL_TYPE = 0;
parameter DEF_CFG_ZQINIT_CAL_DURATION = 667;
