...
//238617/1743273/2.50/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-07240RL" (originalName "RC0402FR-07240RL")
	...
	(compDef "RC0402FR-07240RL" (originalName "RC0402FR-07240RL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-07240RL"))
		...
		(attr "Mouser Part Number" "603-RC0402FR-07240RL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Yageo/RC0402FR-07240RL?qs=UOUeRUa%252B8WlvTJm%2FWhbzSg%3D%3D")
		(attr "Manufacturer_Name" "Yageo Group")
		(attr "Manufacturer_Part_Number" "RC0402FR-07240RL")
		(attr "Description" "YAGEO - RC0402FR-07240RL - RES, 240R, 1%, 0.063W, 0402, THICK FILM")
		(attr "<Hyperlink>" "http://www.yageo.com/documents/recent/PYu-RC0402_51_RoHS_L_6_r.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-07240RL.stp")
