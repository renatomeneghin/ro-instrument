...
//255482/1743273/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "INA226AQDGSRQ1" (originalName "INA226AQDGSRQ1")
	...
	(compDef "INA226AQDGSRQ1" (originalName "INA226AQDGSRQ1") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "A1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "A0") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "10" (pinName "IN+") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "IN-") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "VBUS") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "GND") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VS") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "INA226AQDGSRQ1"))
		...
		(attr "Mouser Part Number" "595-INA226AQDGSRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/INA226AQDGSRQ1?qs=uNh9J9Y3wTf1B1%2FBFFp7SA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "INA226AQDGSRQ1")
		(attr "Description" "AEC-Q100, 36V, Bi-Directional, High Accuracy, Low-/High-Side, I2C Out Current/Power Monitor w/Alert")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/ina226-q1")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "INA226AQDGSRQ1.stp")
