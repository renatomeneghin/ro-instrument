...
//257769/1743273/2.50/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-0710RL" (originalName "RC0402FR-0710RL")
	...
	(compDef "RC0402FR-0710RL" (originalName "RC0402FR-0710RL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-0710RL"))
		...
		(attr "Mouser Part Number" "603-RC0402FR-0710RL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/YAGEO/RC0402FR-0710RL?qs=V1yeUXFNrkkzkWCUUWS9og%3D%3D")
		(attr "Manufacturer_Name" "Yageo Group")
		(attr "Manufacturer_Part_Number" "RC0402FR-0710RL")
		(attr "Description" "Res SMD 0402 10R 1% 0.0625W T.C.200ppm Yageo RC Series Thick Film Surface Mount Resistor 0402 Case 10 +/-1% 0.063W +/-200ppm/C")
		(attr "<Hyperlink>" "http://www.yageo.com/documents/recent/PYu-RC0402_51_RoHS_L_6_r.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-0710RL.stp")
