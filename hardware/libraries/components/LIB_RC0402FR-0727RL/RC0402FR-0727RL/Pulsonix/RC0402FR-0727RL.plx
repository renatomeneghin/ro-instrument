...
//16245652/1743273/2.50/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-0727RL" (originalName "RC0402FR-0727RL")
	...
	(compDef "RC0402FR-0727RL" (originalName "RC0402FR-0727RL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-0727RL"))
		...
		(attr "Mouser Part Number" "603-RC0402FR-0727RL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/YAGEO/RC0402FR-0727RL?qs=UOUeRUa%252B8Wlb37UyFHw9Bw%3D%3D")
		(attr "Manufacturer_Name" "Yageo Group")
		(attr "Manufacturer_Part_Number" "RC0402FR-0727RL")
		(attr "Description" "27 Ohms +/-1% 0.063W, 1/16W Chip Resistor 0402 (1005 Metric) Moisture Resistant Thick Film ,-55C ~ 155C")
		(attr "<Hyperlink>" "https://www.yageogroup.com/content/datasheet/asset/file/PYU-RC_GROUP_51_ROHS_L")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-0727RL.stp")
