...
//621784/1743273/2.50/8/3/Undefined or Miscellaneous
...
(library Library_1
	...
	(symbolDef "SN65HVD234QDRQ1" (originalName "SN65HVD234QDRQ1")
	...
	(compDef "SN65HVD234QDRQ1" (originalName "SN65HVD234QDRQ1") (compHeader (numPins 8) (numParts 1) (refDesPrefix U)
		)
		(compPin "1" (pinName "TXD") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Output))
		...
		(compPin "4" (pinName "RXD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "8" (pinName "RS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(compPin "5" (pinName "EN") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Input))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN65HVD234QDRQ1"))
		...
		(attr "Mouser Part Number" "595-SN65HVD234QDRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/SN65HVD234QDRQ1?qs=vxeUf0TWHS1ncTjp6RJM2A%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "SN65HVD234QDRQ1")
		(attr "Description" "3.3-V Automotive CAN Bus Transceivers")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/sn65hvd234-q1")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "SN65HVD234QDRQ1.stp")
