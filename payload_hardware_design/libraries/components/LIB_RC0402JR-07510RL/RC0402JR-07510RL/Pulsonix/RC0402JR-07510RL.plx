...
//603876/1743273/2.50/2/0/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402JR-07510RL" (originalName "RC0402JR-07510RL")
	...
	(compDef "RC0402JR-07510RL" (originalName "RC0402JR-07510RL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402JR-07510RL"))
		...
		(attr "Mouser Part Number" "603-RC0402JR-07510RL")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=603-RC0402JR-07510RL")
		(attr "Manufacturer_Name" "Yageo Group")
		(attr "Manufacturer_Part_Number" "RC0402JR-07510RL")
		(attr "Description" "RESISTOR, 0402 510 Ohms +/-5% 1/16 W")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/RC0402JR-07510RL.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402JR-07510RL.stp")
