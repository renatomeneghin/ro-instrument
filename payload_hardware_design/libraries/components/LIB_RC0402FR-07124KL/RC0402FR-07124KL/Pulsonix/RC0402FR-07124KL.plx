...
//603755/1743273/2.50/2/0/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-07124KL" (originalName "RC0402FR-07124KL")
	...
	(compDef "RC0402FR-07124KL" (originalName "RC0402FR-07124KL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-07124KL"))
		...
		(attr "Mouser Part Number" "603-RC0402FR-07124KL")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=603-RC0402FR-07124KL")
		(attr "Manufacturer_Name" "Yageo Group")
		(attr "Manufacturer_Part_Number" "RC0402FR-07124KL")
		(attr "Description" "RESISTOR, 0402 124K Ohms +/-1% 1/16 W")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/RC0402FR-07124KL.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-07124KL.stp")
