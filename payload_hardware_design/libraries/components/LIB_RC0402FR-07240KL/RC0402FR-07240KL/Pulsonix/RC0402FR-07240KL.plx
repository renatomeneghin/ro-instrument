...
//267043/1743273/2.50/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-07240KL" (originalName "RC0402FR-07240KL")
	...
	(compDef "RC0402FR-07240KL" (originalName "RC0402FR-07240KL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-07240KL"))
		...
		(attr "Mouser Part Number" "603-RC0402FR-07240KL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/YAGEO/RC0402FR-07240KL?qs=UOUeRUa%252B8Wk%2FVV3xbpEz8g%3D%3D")
		(attr "Manufacturer_Name" "Yageo Group")
		(attr "Manufacturer_Part_Number" "RC0402FR-07240KL")
		(attr "Description" "YAGEO (PHYCOMP) - RC0402FR-07240KL - RES, THICK FILM, 240K, 1%, 0.063W, 0402")
		(attr "<Hyperlink>" "http://www.yageo.com/documents/recent/PYu-RC0402_51_RoHS_L_6_r.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-07240KL.stp")
