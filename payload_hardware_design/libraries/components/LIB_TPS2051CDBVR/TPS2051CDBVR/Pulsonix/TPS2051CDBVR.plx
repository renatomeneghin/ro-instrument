...
//257970/1743273/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS2051CDBVR" (originalName "TPS2051CDBVR")
	...
	(compDef "TPS2051CDBVR" (originalName "TPS2051CDBVR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "__FLT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "EN/__EN") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "IN") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS2051CDBVR"))
		...
		(attr "Mouser Part Number" "595-TPS2051CDBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS2051CDBVR?qs=PF3AD18CSE5vi2HeWLJCmw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS2051CDBVR")
		(attr "Description" "Single Channel, Current-Limited USB Power Distribution Switch")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tps2051c")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TPS2051CDBVR.stp")
