...
//603824/1743273/2.50/2/0/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-078K06L" (originalName "RC0402FR-078K06L")
	...
	(compDef "RC0402FR-078K06L" (originalName "RC0402FR-078K06L") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-078K06L"))
		...
		(attr "Manufacturer_Part_Number" "RC0402FR-078K06L")
		(attr "Description" "RESISTOR, 0402 8.06K Ohms +/-1% 1/16 W")
		(attr "<Hyperlink>" "http://www.yageo.com/documents/recent/PYu-RC0402_51_RoHS_L_6_r.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-078K06L.stp")
