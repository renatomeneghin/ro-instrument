...
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DDR_READ } ]
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/RESET } ]
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DELAY_LINE_DIRECTION } ]
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DELAY_LINE_MOVE } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DELAY_LINE_LOAD DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DELAY_LINE_SEL } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/SWITCH } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/READ_CLK_SEL[2] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[0] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[1] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[2] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[3] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[4] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[5] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[6] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_2_CTRL/I_LANECTRL/DLL_CODE[7] } ]
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DDR_READ } ]
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/RESET } ]
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DELAY_LINE_DIRECTION } ]
set_false_path -to [get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DELAY_LINE_MOVE } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DELAY_LINE_LOAD DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DELAY_LINE_SEL } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/SWITCH } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/READ_CLK_SEL[2] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[0] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[1] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[2] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[3] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[4] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[5] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[6] } ]
set_false_path -to [ get_pins { DDRPHY_BLK_0/LANE_3_CTRL/I_LANECTRL/DLL_CODE[7] } ]

########################################################## IOA CONSTRAINTS ##########################################################

set_false_path -through [get_pins { DDRPHY_BLK_0/*/I_*FEEDBACK*/Y }]
set_false_path -through [get_pins { DDRPHY_BLK_0/OB_DIFF_CK0/Y }]
set_false_path -through [get_pins { DDRPHY_BLK_0/OB_A_9/Y }]
